...
function solve() {
    ...
    let address = document.getElementById('address').value; // Added address variable
    let flag = 1;
    ...
    // Validate the address (you can add your specific address validation logic here)
    if (address.trim() === "") {
        flag = 0;
        pass.innerText = 'Please enter your address.';
        setTimeout(() => {
            pass.innerText = "";
        }, 3000);
    }
